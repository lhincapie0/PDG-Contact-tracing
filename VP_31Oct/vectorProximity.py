...
# Además, tiene los datos necesarios para la ejecución e impresión de pruebas para el día 31 de octubre
...
# Instantes de tiempo para cada prueba realizada el día 15 de octubre
